...
public class Freez extends Character {
    ...
    static {
        ...
        down.add(new Texture("freez5.png"));
        down.add(new Texture("freez6.png"));
        down.add(new Texture("freez8.png"));
        right.add(new Texture("freez1.png"));
        right.add(new Texture("freez2.png"));
        left.add(new Texture("freez3.png"));
        left.add(new Texture("freez4.png"));
    }
}
